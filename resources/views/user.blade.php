        ...
        <form class="col s12" action="{{ route('userUpdate') }}" method="POST">
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input value="{!! $user->name !!}" name="name" placeholder="Name" id="name" type="text" class="validate" required
                        disabled>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input value="{!! $user->email !!}" name="email" id="email" type="email" class="validate" required disabled>
